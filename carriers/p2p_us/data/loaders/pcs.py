...
P2P US filters by country (United States of America) instead of carrier.
"""
...
# Defaults for P2P US
DEFAULT_CARRIER = None  # Don't filter by carrier
DEFAULT_PRODUCTION_SITES = ["Columbus"]  # ORD origin (Chicago) but Columbus production
...
def load_pcs_shipments(
    ...
    carrier: Optional[str] = DEFAULT_CARRIER,
    ...
    Args:
        ...
        carrier: Carrier extkey filter, defaults to None (no filter)
