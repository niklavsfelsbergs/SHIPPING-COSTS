...
Usage:
    python -m carriers.maersk_us.scripts.upload_expected --full
    python -m carriers.maersk_us.scripts.upload_expected --incremental
    python -m carriers.maersk_us.scripts.upload_expected --days 7
    python -m carriers.maersk_us.scripts.upload_expected --full --dry-run
"""
...
TABLE_NAME = "shipping_costs.expected_shipping_costs_maersk_us"
