-- Create expected_shipping_costs_maersk_us table
-- Maersk US domestic last mile expected costs from calculator
--
-- Run this DDL in Redshift before using upload_expected.py

CREATE TABLE IF NOT EXISTS shipping_costs.expected_shipping_costs_maersk_us (
    -- Identification (7)
    pcs_orderid             BIGINT,
    ...
    cost_pickup             DECIMAL(10,2),      -- $0.04/lb
...
-- Grant permissions
GRANT ALL ON shipping_costs.expected_shipping_costs_maersk_us TO tcg_nfe;
