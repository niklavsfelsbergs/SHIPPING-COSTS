...
Calculates expected FedEx shipping costs and uploads them to the database.
...
Usage:
    ...
    python -m carriers.fedex.scripts.upload_expected --full --dry-run
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="Upload expected FedEx shipping costs to database",
