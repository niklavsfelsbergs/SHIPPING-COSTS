...
Pulls FedEx shipment data from the PCS database.
"""
...
DEFAULT_PRODUCTION_SITES = ["Columbus", "Miami", "Phoenix"]
...
def load_pcs_shipments(
    ...
    carrier_pattern: str = DEFAULT_CARRIER_PATTERN,
    ...
    Args:
        ...
        carrier_pattern: Carrier extkey LIKE pattern, defaults to 'FX%'
    ...
    carrier_filter = ""
    if carrier_pattern:
        carrier_filter = f"and ps.extkey LIKE '{carrier_pattern}'"
